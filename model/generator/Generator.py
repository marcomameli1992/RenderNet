...
class Generator(NN.Module):
        ...
        def __init__(self, in_channels, out_channels, use_all=True, use_albedo=False, use_depth=False, use_emissive=False, use_metalness=False, use_normal=False, use_roughness=False, use_position=False):
